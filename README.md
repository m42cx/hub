# Hub for Dagcoin network

This is a node for Dagcoin network that serves as [relay](), plus facilitates exchange of end-to-end encrypted messages among devices connected to Dagcoin network.  The hub does not hold any private keys and cannot send payments itself.
